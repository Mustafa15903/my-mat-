    ...
    <div className="space-y-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Products */}
          <div
            className="p-6 rounded-xl shadow-sm relative overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-sm font-medium" style={{ color: luxuryColors.textSecondary }}>Total Products</h3>
              <p className="text-4xl font-bold mt-2" style={{ color: luxuryColors.textPrimary }}>{stats.products}</p>
              <div className="mt-4 flex items-center text-sm" style={{ color: luxuryColors.success }}>
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-sm font-medium" style={{ color: luxuryColors.textSecondary }}>Total Categories</h3>
              <p className="text-4xl font-bold mt-2" style={{ color: luxuryColors.textPrimary }}>{stats.categories}</p>
              <div className="mt-4 flex items-center text-sm" style={{ color: luxuryColors.accentGold }}>
                <TrendingUp className="w-4 h-4 mr-1" />
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-sm font-medium" style={{ color: luxuryColors.textSecondary }}>Total Orders</h3>
              <p className="text-4xl font-bold mt-2" style={{ color: luxuryColors.textPrimary }}>{stats.orders}</p>
              <div className="mt-4 flex items-center text-sm" style={{ color: luxuryColors.accentGreen }}>
                <TrendingUp className="w-4 h-4 mr-1" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div
          ...
          style={{ backgroundColor: luxuryColors.bgLight, border: `1px solid ${luxuryColors.border}` }}
        >
          <h3 className="text-lg font-semibold mb-6" style={{ color: luxuryColors.textPrimary }}>Revenue Trends</h3>
          <OverviewChart />
        </div>
        ...
        <div
          ...
          style={{ backgroundColor: luxuryColors.bgLight, border: `1px solid ${luxuryColors.border}` }}
        >
          <h3 className="text-lg font-semibold mb-4" style={{ color: luxuryColors.textPrimary }}>Recent Activity</h3>
            ...
            {[
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium" style={{ color: luxuryColors.textPrimary }}>{activity.action}</p>
